...
for line in sys.stdin:
    ...
    if current_word == word:
        ...
        if current_count >= max_count and current_word != "None":
            max_count= current_count 
            max_word = current_word
        elif current_count >= max_count -1 and current_word != "None":
            max_count2 = current_count
            max_word2 = current_word
        elif current_count >= max_count -2 and current_word != "None":
            max_count3 = current_count
            max_word3 = current_word
        elif current_count >= max_count -3 and current_word != "None":
            max_count4 = current_count
            max_word4 = current_word
        elif current_count >= max_count -4 and current_word != "None":
